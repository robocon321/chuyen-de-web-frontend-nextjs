          ...
          {arrNum.map((item) => {
            if (item != shopState.infoPages.number + 1) {
              return (
                ...
                >
                  <a className={styles["page-btn"]} key={item}>
                    {item}
                  </a>
                </Link>
              );
